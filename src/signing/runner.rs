...
pub struct MainRunner {
    ...
    transaction_map: BTreeMap<u64, Reply>,
    quorum: bool,
}
...
impl MainRunner {
    ...
    pub async fn insert(&self, message: Bytes) -> Result<u64> {
        debug!("Insert Message to the signer ");
        let transaction_id: u64 = new_rand::random();
